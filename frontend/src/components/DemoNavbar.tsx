...
import { DemoCategoryMegaMenu } from "./DemoCategoryMegaMenu";
  ...
  return (
    <>
      ...
      <div className="z-40 shadow-sm shadow-gray-300 dark:shadow-gray-800 xl:sticky xl:top-0">
        <DemoCategoryMegaMenu mobileSidebarOpen={mobileSidebarOpen} onMobileSidebarOpenChange={setMobileSidebarOpen} />
      </div>
    </>
  );
}
