  ...
  return (
    ...
    >
      {product.discountLabel ? (
        <Badge
          variant="secondary"
          className="absolute top-2 right-2 z-10 bg-violet-600 text-white hover:bg-violet-600"
        >
          {product.discountLabel}
        </Badge>
      ) : null}
      ...
      <CardContent className="px-3 pt-2 pb-1">
        <Link
          href="#"
          className="line-clamp-2 font-heading text-sm font-semibold leading-snug text-foreground hover:text-orange-500"
        >
          {product.title}
        </Link>
