...
import {getFilterOptionsForPath} from "@/data/sidebar-filters";
...
export function CategoryFilters({className, currentPath}: {className?: string; currentPath: string}) {
  ...
  const normalizeQueryValue = React.useCallback(
    (filterTitle: string, rawValue: string) => {
