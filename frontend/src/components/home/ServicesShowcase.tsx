...
const services = [
  ...
  },
  {
    id: 3,
    title: "Home Service",
    description: "Get professional service at your doorstep",
    icon: Home,
            ...
            <Card className="group relative overflow-hidden bg-white dark:bg-card shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer ring-0 ring-transparent">
                  <CardContent className="relative">
                    ...
                    <div className="flex items-center gap-4">
                      {/* Small Icon */}
                      <div className={`inline-flex h-12 w-12 items-center justify-center rounded-full bg-red-500 group-hover:scale-110 transition-transform duration-300 flex-shrink-0 overflow-hidden aspect-square`}>
                        <Laptop className="h-6 w-6 text-white flex-shrink-0" />
                      </div>
          ...
          <Link target="_blank" key={service.id} href={service.href}>
            <Card className="group relative overflow-hidden bg-white dark:bg-card shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer ring-0 ring-transparent">
                  <CardContent className="relative">
                    ...
                    <div className="flex items-center gap-4">
                      {/* Small Icon */}
                      <div className={`inline-flex h-12 w-12 items-center justify-center rounded-full ${service.color} group-hover:scale-110 transition-transform duration-300 flex-shrink-0 overflow-hidden aspect-square`}>
