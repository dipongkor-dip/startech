...
export function ScrollingText() {
  return (
    <div className="w-full bg-gradient-to-r mb-5 from-gray-100 dark:from-gray-800 to-gray-200 dark:to-gray-700 text-gray-900 dark:text-gray-100 py-2 overflow-hidden rounded-full">
