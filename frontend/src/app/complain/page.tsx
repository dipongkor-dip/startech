...
export default function ComplainPage() {
  ...
  return (
    <div className="min-h-screen my-5 border max-w-7xl mx-auto shadow-md p-10">
        {/* Header */}
        <div className="text-center mb-5">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            We're here to help. Submit your complaint and we'll resolve it quickly.
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        required
                        className="w-full border-0 border-b-2 border-gray-300 rounded-none focus:border-blue-500 focus:ring-0 px-0 py-2 dark:border-gray-600 input-font-poppins"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="w-full border-0 border-b-2 border-gray-300 rounded-none focus:border-blue-500 focus:ring-0 px-0 py-2 dark:border-gray-600"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      required
                      className="w-full px-0 py-2 border-0 border-b-2 border-gray-300 rounded-none focus:border-blue-500 focus:ring-0 bg-white dark:bg-background text-gray-900 dark:text-white dark:border-gray-600 input-font-poppins"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={6}
                      required
                      className="w-full px-0 py-2 border-0 border-b-2 border-gray-300 rounded-none focus:ring-0 bg-white dark:bg-background text-gray-900 dark:text-white dark:border-gray-600 input-font-poppins"
                    />
                  </div>
